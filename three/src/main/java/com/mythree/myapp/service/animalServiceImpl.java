...
import com.mythree.myapp.dao.animalDao;
...
public class animalServiceImpl implements animalService{
	...
	public void getList(HttpServletRequest request) {
		...
		*/
		...
		//파일 목록 얻어오기
		List<animalDto> list=cafeDao.getList(dto);
		//전체 row 의 갯수 
	...
	public void saveContent(animalDto dto) {
		animalDao.insert(dto);
	}

	@Override
	public void updateContent(animalDto dto) {
		animalDao.update(dto);
	}

	@Override
	public void deleteContent(int num, HttpServletRequest request) {
		
		animalDao.delete(num);
	}

	
		//카페글 목록 얻어오기
		List<animalDto> list=animalDao.getList(dto);
